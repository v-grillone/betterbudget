        ...
        <table className="w-full">
          <thead className="bg-stone-100">
            <tr>
              ...
              <th className="hidden sm:table-cell px-3 py-2 text-left text-xs font-medium text-stone-500 uppercase tracking-wide">Category</th>
            ...
            {transactions.length === 0 ? (
              ...
              transactions.map((t) => (
                <tr
                  ...
                  className="border-t border-stone-200 hover:bg-stone-300 transition-colors duration-150 cursor-pointer"
                >
                  ...
                  <td className="hidden sm:table-cell px-3 py-3 text-sm text-stone-500 capitalize">{t.category}</td>
